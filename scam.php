...
<title>Scam or Trust Website Analyzer</title>
<br />
        <center> <font color="red" face="iceland" size="10">Scam or Trust Website Analyzer</font>
		 <br /> <br />
<img src="https://cdn.pbrd.co/images/6RXeCi5n8.png" width="100" height="100">
<br /> <br />

		<form action="" id="form1" method="get" onsubmit=" location.href = 'https://www.scamadviser.com/check-website/' + document.getElementById('url').value; return false; "> 
